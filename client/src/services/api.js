...
class Api {
  ...
  async get(url = '', params = {}) {
    ...
    try {
      ...
      console.log(
        'GET' + ' url:' + url + '  data:' + JSON.stringify(response.data)
      )
  ...
  async post(url = '', params = {}, overlay = true) {
    ...
    this.axios.defaults.headers['csrf-token'] = getCsrfToken()
    this.axios.defaults.headers['csrf-token2'] = getCsrfToken()
    ...
    try {
      ...
      console.log(
        'POST' + ' url:' + url + '  data:' + JSON.stringify(response.data)
      )
  ...
  async put(url = '', params = {}, overlay = true) {
    ...
    try {
      ...
      console.log(
        'PUT' + ' url:' + url + '  data:' + JSON.stringify(response.data)
      )
  ...
  async delete(url = '', params = {}, overlay = true) {
    ...
    try {
      ...
      console.log(
        'DEL' + ' url:' + url + '  data:' + JSON.stringify(response.data)
      )
